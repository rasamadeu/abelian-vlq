...
def pool_function(input_pair):
    ...
    for m_VLQ in range_mass_VLQ:
        ...
        chi_square = 1e20
        i = 0
        while i < 500 and not check_chi_squares_limits(par_values, m_VLQ):
            par_values = []
            chi_square = 1e20
...
#            set_maximally_restrictive_pairs_after_minuit.append(pair)
    ...
    filename = "1_up_0_down_MRT_after_MINUIT_non_unitary_1_sigma(2HDM + only physical parameters + VLQ mass varying).txt"
