...
def K0K0bar(V, mc, mt, mT, return_chi):
    ...
    SM = eta_tt * S0(mt) * lambda_t_ds ** 2 + 2 * eta_ct * S0(mc, mt) * lambda_c_ds * \
        lambda_t_ds + 2 * 1.38 * S0(mc) * lambda_c_ds * lambda_c_ds
...
def eps_ratio(V, F, mu, mc, mt, mT, return_chi):
    ...
    # print("eps_ratio:")
    # print("SM")
    # print(Ft * np.imag(lambda_t_sd))
    bound = eps_ratio - Ft * np.imag(lambda_t_sd)
    ...
    # print("NP_2")
    # print(NP - FT * np.imag(lambda_T_sd))
    ...
    # print(NP)
    # print("eps_ratio")
    # print(Ft * np.imag(lambda_t_sd) + NP)
    chi_square = (bound - NP) ** 2 / bound_error ** 2
...
def top_decay(V, F):
    ...
    # print((top_Zu_bound - abs(F[0, 2])) ** 2 / top_Zu_bound_error ** 2)
    # print("chi_square_t -> Zc = ")
    # print((top_Zc_bound - abs(F[1, 2])) ** 2 / top_Zc_bound_error ** 2)
    # print("chi_square_t -> hu = ")
    # print((top_hu_bound - abs(F[0, 2])) ** 2 / top_hu_bound_error ** 2)
    # print("chi_square_t -> hc = ")
    # print((top_hc_bound - abs(F[1, 2])) ** 2 / top_hc_bound_error ** 2)
    # print()
...
def Bs_mumu_decay(V, F, mu, mc, mt, mT, return_chi):
    ...
    # print("abs(SM) ** 2 = ")
    # print(abs(SM) ** 2)
    chi_square = (abs(SM) ** 2 - bound) ** 2 / bound_error ** 2
    # print("chi_square_Bs_mumu_decay_SM = ")
    # print(chi_square)
...
def K_decay_bound_1(V, F, mu, mc, mt, mT, return_chi):
    ...
    # print("lambda_c_sd")
    # print(lambda_c_sd)
    # print("lambda_t_sd * eta * X0(mt)")
    # print(lambda_t_sd * eta * X0(mt))
    # print("lambda_T_sd * eta * X0(mT)")
    # print(lambda_T_sd * eta * X0(mT))
    # print("NP_sum")
    # print(NP - lambda_T_sd * eta * X0(mT))
    # print("decay_value = ")
    # print(decay_value)
...
def K_decay_bound_2(V, F, mu, mc, mt, mT, return_chi):
    ...
    # print("|Vus|^2")
    # print(abs(V[0, 1]) ** 2)
    # print("Y * np.real(lambda_c_sd) = ")
    # print(Y * np.real(lambda_c_sd))
    # print("eta * np.real(lambda_t_sd) * Y0(mt) = ")
    # print(eta * np.real(lambda_t_sd) * Y0(mt))
    # print("eta * np.real(lambda_T_sd) * Y0(mT) = ")
    # print(eta * np.real(lambda_T_sd) * Y0(mT))
    # print("NP sum = ")
    # print(NP - eta * np.real(lambda_T_sd) * Y0(mT))
    # print("abs(SM + NP) ** 2 = ")
    # print(abs(SM + NP) ** 2)
    # print("NP = ")
    # print(NP)
...
def K_decay_bound_3(V, F, mu, mc, mt, mT, return_chi):
    ...
    # print("bound = ")
    # print(Br_KL_Pi0nunu / Br_KL_Pi0nunu_SM)
    # print("bound_error = ")
    # print(Br_KL_Pi0nunu / Br_KL_Pi0nunu_SM *
    #          (1 / Br_KL_Pi0nunu_SM * Br_KL_Pi0nunu_SM_error))
    # print("lambda_c_sd * X0(mc)")
    # print(lambda_c_sd * X0(mc))
    # print("lambda_t_sd * X0(mt)")
    # print(lambda_t_sd * X0(mt))
    # print("lambda_T_sd * X0(mT)")
    # print(lambda_T_sd * X0(mT))
    # print("NP sum")
    # print(NP - lambda_T_sd * X0(mT))
    # print("abs(np.imag(SM + NP)) ** 2 = ")
    # print(abs(np.imag(SM + NP)) ** 2)
    # print("NP = ")
    # print(NP)
    # print("abs(np.imag(SM + NP)/np.imag(SM)) ** 2 = ")
    # print(abs(np.imag(SM + NP)/np.imag(SM)) ** 2)
    chi_square = 1e10
    if bound_error != 0:
...
def main():
    ...
    np.set_# printoptions(linewidth=np.inf)
...
#                 [0, 0, 0]])
    ...
    M_u = np.array(
[[0.00000000e+00+0.j, 0.00000000e+00+0.j, 7.19390089e+00+0.j, 1.26586193e+00+0.j],
 [0.00000000e+00+0.j, 4.57026174e+00+0.j, 0.00000000e+00+0.j, 1.16724231e-01+0.j],
 [5.64450806e-01+0.j, 0.00000000e+00+0.j, 1.72539164e+02+0.j, 0.00000000e+00+0.j],
 [0.00000000e+00+0.j, 1.09615608e+03+0.j, 0.00000000e+00+0.j, 0.00000000e+00+0.j]]
    )

    M_d = np.array(
[[ 0.00000000e+00+0.j,         0.00000000e+00+0.j,         9.14070188e-02+0.j        ],
 [ 0.00000000e+00+0.j,         4.77182175e-03+0.j,        -3.19885530e-04-0.01916385j],
 [ 4.18000000e+00+0.j,         0.00000000e+00+0.j,         0.00000000e+00+0.j        ]]
    )
    ...
    # print("F:")
    # print(F)
    results = phenomenology_tests(V, F, D_u[0], D_u[1], D_u[2], D_u[3])
